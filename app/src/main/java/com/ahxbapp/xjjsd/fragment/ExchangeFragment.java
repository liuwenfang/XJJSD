...
public class ExchangeFragment extends BaseFragment implements PullToRefreshScrollView.OnRefreshListener{
    @ViewById
    ...
    @AfterViews
    void initView() {
        webUrl = APIManager.exchargeUrl;
        mToolbarTitleTV.setText("兑现");
