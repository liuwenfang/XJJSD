...
import com.ahxbapp.xjjsd.activity.ContactPersonActivity;
...
public class GetContactsInfo {
    ...
    ContactPersonActivity mContext;

    public GetContactsInfo(Context context, ContactPersonActivity mContext) {
